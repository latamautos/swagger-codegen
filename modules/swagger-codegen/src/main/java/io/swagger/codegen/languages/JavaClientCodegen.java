...
public class JavaClientCodegen extends DefaultCodegen implements CodegenConfig {
    ...
    protected String hostEnvVarible = "API_ADMIN_JAVA";
    protected String hostPortEnvVarible = "API_PORT";
    ...
    public void processOpts() {
        ...
        if (additionalProperties.containsKey("hostEnvVarible")) {
            this.setHostEnvVarible((String) additionalProperties.get("hostEnvVarible"));
        } else {
            //not set, use default to be passed to template
            additionalProperties.put("hostEnvVarible", hostEnvVarible);
        }

        if (additionalProperties.containsKey("hostPortEnvVarible")) {
            this.setHostPortEnvVarible((String) additionalProperties.get("hostPortEnvVarible"));
        } else {
            //not set, use default to be passed to template
            additionalProperties.put("hostPortEnvVarible", hostPortEnvVarible);
        }
    ...
    public void setHostEnvVarible(String hostEnvVarible) {
        this.hostEnvVarible = hostEnvVarible;
    }

    public void setHostPortEnvVarible(String hostPortEnvVarible) {
        this.hostPortEnvVarible = hostPortEnvVarible;
    }
}
